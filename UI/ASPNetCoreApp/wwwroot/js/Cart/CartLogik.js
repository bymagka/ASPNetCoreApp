Cart = {
    ...
    init: function (_properties) {
        $.extend(Cart._properties, _properties);
    ...
    addToCart: function (event) {
        ...
        $.get(Cart._properties.addToCartLink + "/" + id)
            ...
            .fail(function () { console.log("add to cart failed"); });
    },
    ...
    refreshCartView: function () {
        ...
        $.get(Cart._properties.getCartViewLink)
            .done(function (cartHtml) { container.html(cartHtml); })
            .fail(function () { console.log("refresh cart view failed"); });
    },
    ...
    refreshTotalPrice: function () {
        ...
        const value = total_price.toLocaleString("ru-RU", { style: "currency", currency: "RUB" });
    ...
    removeItem: function (event) {
        ...
        $.get(Cart._properties.removeLink + "/" + id)
            .done(function () {
                tr.remove();
