        ...
        public static IEnumerable<Brand> Brands { get; } = new[]
{
        ...
        public static IEnumerable<Section> Sections { get; } = new[]
        {
             new Section { Id = 1, Name = "Спорт", Order = 0 },
              ...
              new Section { Id = 19, Name = "RussianFendi", Order = 0, ParentId = 18 },
              new Section { Id = 20, Name = "RussianGuess", Order = 1, ParentId = 18 },
              new Section { Id = 21, Name = "RussianValentino", Order = 2, ParentId = 18 },
